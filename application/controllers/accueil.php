...
<<<<<<< HEAD
	...
	private function _createMenu($id_parent = null){
		...
		{	
			$j = 0;
			$menu[$i] = $categorie;
			$scategories = $this->cat->getCategoriesByParent((int)$categorie['id']);
				foreach($scategories as $scategorie)
				{	
					$k = 0;
					$menu[$i] = (array)$menu[$i];
					$menu[$i][$j] = $scategorie;
					$sscategories = $this->cat->getCategoriesByParent((int)$scategorie['id']);
...
>>>>>>> 26035aff8db1ed8a3c705a1a06f9fbbd69954dd9
}
