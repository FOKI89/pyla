            ...
            <div class ="row">
                  <div class="subscribe col s12">
                    ...
                    <div class="divider"></div>
                      <form id="register" class="col s12" action="">
                          <div class="row">
                            <div class="input-field col s12 m6">
                              ...
                              <input value="" id="first_name" type="text" class="validate" name="firstname">
                              <label for="first_name">Prénom:</label>
                            </div>
                            <div class="input-field col s12 m6">
                              <i class="material-icons prefix blue-text darken-4-text">perm_identity</i>
                              <p class="required-fields red-text darken-4-text"><i class=" tiny material-icons">star_rate</i></p>
                              <input value ="" id="last_name" type="text" class="validate" name="lastname">
                          ...
                          <div class="row">
                            <div class="input-field col s12 m6">
                              ...
                              <input id="adresse" type="text" class="validate" name="address">
                              <label for="adresse">Adresse:</label>
                            </div>
                            <div class="input-field col s12 m6">
                              <i class="material-icons prefix blue-text darken-4-text">label</i>
                              <input id="ville" type="text" class="validate" name="city">
                          ...
                          <div class="row">
                            <div class="input-field col s12 m6">
                              <i class="material-icons prefix blue-text darken-4-text">label</i>
                              <input id="codePostal" type="text" class="validate" name="cp">
                              <label for="codePostal">Code Postal:</label>
                            </div>
                            <div class="input-field col s12 m6">
                              <i class="material-icons prefix blue-text darken-4-text">label</i>
                              <input id="pays" type="text" class="validate" name="country">
