		...
		<header>
 			<div class="row">
			    ...
			    <a href="" class="brand-logo">
			        	<img class="" src="<?php echo img_url("logo-2.png") ?>" alt="logo pila">
			    </a>
			    </div>
			    <!-- Champs de recherche  -->
				...
				<div class="container">
					<ul class="center hide-on-med-and-down desktop">
						<li><a href="#">Chaussures</a>
							<div class="subMenu yellow blue-text row">
								<ul class="col l4">
								...
								<div class="col l4">
									<a href="#"><img src="<?php echo img_url("logo-2.png") ?>" alt=""></a>
									<p class="blue-text">Card Title</p>
