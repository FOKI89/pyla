<div class="col l4 m4 s12">
  <ul class="collapsible collapsible-accordion" id="nav-account">
            <li class="no-padding"><a href="#" data-nav="dashboard-account">Dashboard</a></li>
            <li class="no-padding"><a href="#" class="purple lighten-5" data-nav="informations-personnelles-account">Mes informations personnelles</a></li>
            <li>
