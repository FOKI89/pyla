<div class="row products-container">
	...
	<div class="col s12 m12 l6 product">
			<div class="col s12 m8 card z-depth-0">
				...
				<div class="card-reveal indigo lighten-5">
					...
					<a class="btn waves-effect waves-light blue yellow-text" href="<?php echo base_url().'categorie/'.$categorie['id'];?>">Zoom sur le produit <i class="material-icons left">zoom_in</i></a>
				</div>
			</div>
			<div class="card col m4 hide-on-small-only side-part-product z-depth-0">
