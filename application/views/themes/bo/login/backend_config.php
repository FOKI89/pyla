...
<head>
  <title>Back Office - Configuration</title>
  ...
  <script src="<?php echo js_url("bo/form_config"); ?>"></script>
</head>    
    <body>
      <div class="container">
            ...
            <form id="configuration">
              <div class="row blue darken-4 white-text valign-wrapper">
                ...
                <div class="col s9 valign">
                    <h5>Configuration Back Office</h5>
                </div>
              </div>
              <!-- Corps du formulaire-->
              <div class="row">
                <div class="form col s8 offset-s2">
                  ...
                  <p class="center-align">
                    <button class="btn waves-effect waves-light btn-large submit-button" type="submit" name="configuration">Valider
      ...
      <script type="text/javascript" src="<?php echo js_url("bo/form_config"); ?>"></script>
