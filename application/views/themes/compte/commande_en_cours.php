				...
				<li>
					...
					<div class="collapsible-body">
						<ul>
							...
							<li><a href="<?php echo base_url().'mon-compte/mes-ventes/terminees'; ?>">Ventes terminées</a></li><li><a href="<?php echo base_url().'mon-compte/mes-ventes/creer_article'; ?>">Créer un article</a></li>
